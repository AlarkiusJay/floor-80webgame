...
FL80R (*"Floor 80"*) drops you partway up an 80-storey building and dares you to reach the top. Each floor is a self-contained challenge: a riddle, a bit of math, something hidden in plain sight, a chase, or a boss. Solve it to climb. There are no saves and no checkpoints. It's one continuous run to the top.
...
- **Bring a pen and paper.** Some floors are *memory* floors: they ask what your answer was several floors ago. The game warns you up front, so remember: memory is not optional.
...
- **Circuit:** a wiring/logic puzzle that guards each boss (floors 9, 19, 29, and so on).
